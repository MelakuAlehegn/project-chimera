...
/**
 * JUnit 5 tests asserting that Skill interfaces accept the correct parameters
 * and handle exceptions as defined in specs/technical.md.
 *
 * These tests are written before implementation (TDD "empty slot").
 * They compile and run, but fail because the implementation is not yet provided.
 */
class SkillsInterfaceTest {
    ...
    // --- BudgetExceededException contract ---
